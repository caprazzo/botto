...
public class ExampleEngineMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            connectionManager.addBot(bot, new JID("something@caprazzi.net"), smackConnector);
        ...
        try {
            AbstractBot bot = makeBot(new ABot());
            connectionManager.addBot(bot, new JID("something_else@caprazzi.net"), smackConnector);
        } catch (ConnectorException e) {
            throw new RuntimeException(e);
        }
